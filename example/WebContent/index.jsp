...
<meta name="keywords"
	content="fullpage,jquery,demo,screen,fullscreen,backgrounds,full-screen" />
...
<body>
	...
	<nav class="container row">
		<div class="nav-wrapper #ef9a9a red lighten-3"><a href="#" class="brand-logo">Logo</a>
	...
	<div id="fullpage">
		<div class="section " id="section0">
			...
			<div class="layer" style="background-color: grey; opacity: 0.7;">
				<br><br><br>
				<h1>휴식이 있는 쉼(,)카</h1>
				<br><br><br>
			</div>
		...
		<div class="section" id="section1">
			<div class="slide" id="slide1">
				<h1><img src="images/bg1.jpg"></h1>
			</div>
			<div class="slide" id="slide2">
				<h1><img src="images/bg2.jpg"></h1>
			</div>
			<div class="slide" id="slide3">
				<h1>Totally customizable<img src="images/bg3.jpg"></h1>
			</div>
			<div class="slide" id="slide4">
				<h1>Totally customizable<img src="images/bg4.jpg"></h1>
			</div>
